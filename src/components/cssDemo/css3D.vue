<template>
  <div id="pageContainer">
    ...
    <div class="page-btf">
      ...
      <div style="text-align:center;clear:both;position:absolute;top:30px;left:260px;z-index:999"></div>
              ...
              <var class="translate3d">
                <var class="translate3d-1">
                  <figure class="butterfly">
                    ...
                    <svg class="wing right con shape-codepen" viewBox="0 0 50 100">
                      <use class="left" xlink:href="#shape-butterfly-1"></use>
                    </svg>
                  </figure>
                </var>
...
export default {
  ...
  activated() {
    // keep-alive 组件激活时调用。
    this.$store.commit("SET_TITLES", "css3D"); // 该方法比较靠谱
  },
  components: {}
};
</script>
...
#box div {
  ...
  text-align: center;
  font-size: 130px;
  background: url("../../common/images/avater.jpg") no-repeat center center;
}
.one {
...
.skybox.cube .face.front {
  ...
  background-image: url("../../common/images/btf/clouds_front.jpg");
}
.skybox.cube .face.back {
  ...
  background-image: url("../../common/images/btf/clouds_back.jpg");
}
.skybox.cube .face.right {
  ...
  background-image: url("../../common/images/btf/clouds_right.jpg");
}
.skybox.cube .face.left {
  ...
  -o-transform: rotateY(90deg) translateZ(-256px);
  transform: rotateY(90deg) translateZ(-256px);
  background-image: url("../../common/images/btf/clouds_left.jpg");
}
.skybox.cube .face.top {
  ...
  background-image: url("../../common/images/btf/clouds_top.jpg");
}
